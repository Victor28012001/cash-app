...
const Navbar = ({darkMode, toggleDarkMode}) => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className={`absolute top-0 left-0 w-full z-10 ${darkMode?'bg-transparent color-black':'bg-[#1e222d] color-white'}  md:flex-row md:flex-nowrap md:justify-start flex items-center p-4`}>
